...
source_name: "Explore Terceira — Festas do Espírito Santo"
excerpt: "Se estás na Terceira este fim-de-semana, notas. Estradas pintadas de fresco, impérios a abrir, cheiro a sopas desde manhã cedo. Os dois grandes fins-de-semana do Espírito Santo são das coisas mais terceirenses do calendário — e a comida é grátis."
---
...
- A página de eventos da **Câmara Municipal de Angra do Heroísmo** em [angradoheroismo.pt](https://angradoheroismo.pt/eventos/), que lista os maiores,
- A Diocese de Angra ([igrejaacores.pt](https://www.igrejaacores.pt/)) para a parte religiosa.
